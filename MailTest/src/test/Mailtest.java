...
public class Mailtest {
	public static void main(String[] args) {
		try {
			String subject="<span style=\"color:red\">span1</span>";
			String Message="<span style='color:yellow;font-size:60px'>span1</span>";
			Mailtest.sendMessage("smtp.163.com", "zhoujundong111@163.com", "xvmdujeduhmorgyi", "1187131468@qq.com", subject, Message, "GBK");
	...
	public static void sendMessage(String smtpHost, String from,  
		...
		transport.connect(smtpHost,"1187131468", fromUserPassword);  
